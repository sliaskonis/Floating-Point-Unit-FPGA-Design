...
HD_PWD='/home/inf2020/ggantsios/ECE 340-EmbeddedSystems/ECE340_lab1/step3/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpadd_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpadd_system.tcl
